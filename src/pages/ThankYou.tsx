...
export function ThankYou() {
  ...
  // Cost estimates (from 2025 reference: $1.96/piece fixed + $1.77/BRM return)
  const fixedCostPerPiece = 1.96;
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
              ...
              <div className="text-xs text-gray-500">Based on 2025 per-piece rates</div>
              <div className="mt-4 space-y-1.5 border-t border-gray-100 pt-3 text-sm">
